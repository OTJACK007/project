...
const navigation = [
  ...
  { name: 'Prestations', href: '/dashboard/prestations', icon: FileText },
  { name: 'Fiches de poste', href: '/dashboard/fiches', icon: ClipboardList },
  { name: 'Contrats', href: '/dashboard/contrats', icon: FileSpreadsheet },
  { name: "Relevés d'heures", href: '/dashboard/releves', icon: Clock },
  { name: 'Factures', href: '/dashboard/factures', icon: FileSpreadsheet },
